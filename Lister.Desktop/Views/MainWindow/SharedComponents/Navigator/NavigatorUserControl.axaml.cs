...
using Lister.Desktop.Views.MainWindow.SharedComponents.BigButtonBlock;
using Lister.Desktop.Views.MainWindow.SharedComponents.Navigator.ViewModel;
using System.Windows.Input;

namespace Lister.Desktop.Views.MainWindow.SharedComponents.Navigator;
...
public partial class NavigatorUserControl : UserControl
{
    ...
    public static readonly StyledProperty<string> ToFirstToolTipProperty =
        AvaloniaProperty.Register<BigButtonBlockUserControl, string> ( "ToFirstToolTip" );
    ...
    public static readonly StyledProperty<string> ToPreviousToolTipProperty =
        AvaloniaProperty.Register<BigButtonBlockUserControl, string> ( "ToPreviousToolTip" );
    ...
    public static readonly StyledProperty<string> ToNextToolTipProperty =
        AvaloniaProperty.Register<BigButtonBlockUserControl, string> ( "ToNextToolTip" );
    ...
    public static readonly StyledProperty<string> ToLastToolTipProperty =
        AvaloniaProperty.Register<BigButtonBlockUserControl, string> ( "ToLastToolTip" );
