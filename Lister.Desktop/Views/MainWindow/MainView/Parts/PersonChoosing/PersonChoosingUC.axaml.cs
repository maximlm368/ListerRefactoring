...
public partial class PersonChoosingUserControl : UserControl
{
    ...
    private SolidColorBrush _borderHovered = new SolidColorBrush ( new Color (255, 81, 76, 72) );
    private SolidColorBrush _backgroundHovered = new SolidColorBrush (new Color (255, 213, 232, 246));

    private SolidColorBrush _borderFocused = new SolidColorBrush (new Color (255, 4, 111, 255));
    private SolidColorBrush _backgroundFocused = new SolidColorBrush (new Color (255, 255, 255, 255));

    private IBrush _borderDefault;
    private SolidColorBrush _backgroundDefault = new SolidColorBrush (new Color (255, 255, 255, 255));
    private SolidColorBrush _backgroundSelected = new SolidColorBrush (new Color (255, 227, 241, 252));
