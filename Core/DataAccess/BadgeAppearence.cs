...
public static class BadgeAppearence
{
    ...
    private static List<TextLine> GetLines ( string jsonPath )
    {
    ...
    private static void SetUnitingLines ( List<TextLine> atoms, string jsonPath )
    {
    ...
    private static List<ComponentImage> GetImages ( string jsonPath )
    {
    ...
    private static TextLine BuildTextLine ( string lineName, string jsonPath, int numberToLocate )
    {
    ...
    private static TextLine BuildTextLine
    ...
    private static ComponentImage BuildInsideImage ( IConfigurationSection section )
    {
    ...
    private static string GetDefaultStrValue ( ICollection<string> steps )
    {
        List<string> keyPathToDefault = BuildPathToDefaultValue ( steps );
        
        return GetSectionStrValue ( keyPathToDefault, _schemeFile.FullName );
    }


    private static int GetSectionIntValueOrDefault ( IConfigurationSection section, string jsonPath
                                                                                  , string propertyName )
    {
    ...
    private static bool GetSectionBoolValueOrDefault ( IConfigurationSection section, string jsonPath
                                                                                    , string propertyName )
    {
        bool result = false;
